...
def menu_principale(background = "white"):
	...
	CTkLabel(app, text = "ENGLISH BIBLE VERSION ", text_font = ("aharoni",20,'bold'), text_color = ("red", "green")).grid(row =0, column =0 , sticky="nw", columnspan = 5)
	...
	CTkLabel(app, text = "Book", text_font = ("aharoni",16)).grid(row =0+1, column = 2, sticky="nw")
	CTkLabel(app, text = "Chapiter", text_font = ("aharoni",16)).grid(row =0+1, column = 4, sticky="nw")
...
connection = connect("BIBLE_En.db")
